...
export default function AppShell() {
  ...
  const isBranchUser   = !!user?.locked_branch;            // account locked to a branch
  ...
  return (
    <div className="app-shell">
      ...
      <div className="app-shell__body">
        {/* Branch context banner — visible whenever a branch is active */}
        {branchInContext && (
          <div style={{
            ...
            <span style={{ fontWeight: 600 }}>
              {isBranchUser ? 'Branch Login' : 'Branch View'}:
            </span>
            ...
            {!isBranchUser && (
              <span style={{ opacity: 0.7, fontSize: '0.72rem' }}>
                All data — POS, orders, reports — shows this branch only
              </span>
            )}
            {canSwitch && (
              <button
