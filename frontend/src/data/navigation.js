export const navigation = [
  ...
  { path: '/vendor',         label: 'Vendor',     icon: 'bi-person-badge', module: 'vendor',    adminOnly: true },
  { path: '/branches',       label: 'Branches',   icon: 'bi-diagram-3',    module: null,        adminOnly: true },
  { path: '/users',          label: 'Users',      icon: 'bi-people-fill',  module: null,        adminOnly: true },
  { path: '/website-config', label: 'Website',    icon: 'bi-globe2',       module: 'website',   adminOnly: true },
